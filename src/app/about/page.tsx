      ...
      <section className="about-author">
        ...
        >
          <section className="about-author__details-photo">
            ...
            <div className="about-author__photo-footer">
              <h1 className="about-author__footer-heading">Sydney W. Joshua</h1>
        ...
        >
          ...
          <p className="about-author__summary-desc">
            ...
            work on Wall Street, the financial capital of the world. Then she
            ...
            children’s school for nearly ten years and also engage in numerous
            extracurricular activities. Following her work in the corporate
            world, Sydney began a second career as an elementary school teacher.
            <br /> <br />
            She is a credentialed model teacher and has mentored numerous novice
            teachers for over a decade. Her book about the trials and
          ...
          <div className="about-books__book-reviews-list">
            <div className="about-books__book-review">
              <p className="about-books__book-review-desc">
                “S is for Superb! This cleverly written story takes us from the
                city life to suburban life while highlighting each letter of the
                alphabet. The relatable storyline is brought to life by the
                nostalgic look back at childhood games, making this an excellent
                and engaging read aloud! A definite must-have for every library
                collection!”
              </p>
